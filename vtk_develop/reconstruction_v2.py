...
JPG_Reader.SetFilePattern("interpolation_out_3d_in/%06d.jpg")     # 这是设置文件名的格式
JPG_Reader.SetFileNameSliceOffset(0)    # 设置从哪个数字开始命名
JPG_Reader.SetDataExtent(0, 511, 0, 511, 0, 1076)# 读取PNG数据的空间范围，z范围代表图片序列数,用来定义要读取的图像序列的范围
JPG_Reader.Update()
